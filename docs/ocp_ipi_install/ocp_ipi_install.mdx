...
### Find out the UUID of Prism Central Subnet

1.  In Prism Central, click on **Subnet**.  Click on **Secondary**

   ![](images/Subnet-1.png)

2.  Note down the **Subnet UUID**

   ![](images/Subnet-2.png)

### Find out the UUID of Prism Element Cluster

1. In Prism Central, click on the cluster.

   ![](images/PE-1.png)

2.  Note down the **Prism Element Cluster UUID**
